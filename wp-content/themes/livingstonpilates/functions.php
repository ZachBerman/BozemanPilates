...
function load_script_css() {
  ...
  wp_register_script('jquery', 'https://code.jquery.com/jquery-3.1.1.min.js', array('var $ = jQuery.noConflict();') ); 
  ...
  wp_register_script('masterJS', get_template_directory_uri() . '/js/master.js', array('jquery', 'var $ = jQuery.noConflict();') );
