...
function load_script_css() {
  ...
  wp_register_script('jquery', 'https://code.jquery.com/jquery-3.1.1.min.js',false, '1.11.2', false);
  ...
  wp_register_script('masterJS', get_template_directory_uri() . '/js/master.js');
